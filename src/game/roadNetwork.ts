...
const edgeDefinitions: Record<RoadEdgeId, { from: RoadNodeId; to: RoadNodeId; points: MapPoint[] }> = {
  ...
  'capital-industrial': {
    ...
    to: 'industrial',
    points: [
      [505, 346], [520, 354], [536, 363], [552, 372], [568, 382],
      [584, 392], [600, 402], [616, 412], [632, 422], [648, 432],
      [664, 442], [680, 452], [696, 462], [712, 472], [728, 482],
    ],
  },
  'farms-industrial': {
    from: 'farms',
    to: 'industrial',
    points: [
      [530, 134], [526, 143], [526, 153], [530, 163], [539, 172],
      [551, 180], [564, 186], [579, 193], [594, 199], [610, 206],
      [626, 213], [642, 220], [659, 228], [676, 236], [692, 244],
      [708, 253], [722, 262], [735, 272], [744, 283], [750, 294],
      [750, 304],
    ],
  },
  'capital-port': {
